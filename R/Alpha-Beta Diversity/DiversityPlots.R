...
gg_pcoa <- plot_ordination(phylobj_rare, pcoa_bc, color = "Soil.Classification") +
  ...
  theme(text = element_text(size = 12), # Changes global text size
        axis.text = element_text(size = 14), # Changes axis text size
        legend.text = element_text(size = 12)) + # Changes legend text size
...
sample_data_df$Soil.Classification[sample_data_df$Soil.Classification %in% c("Gleyed Dystric Brunisol","Mesic Ultic Haploxeralfs", "Orthic Dystric Brunisol", "Orthic Humo-Ferric Podzol", "NA")] <- "Soil Group 3"
